...
#. .. _hrm-ug-049__li0177144134310:
   ...
   .. table:: **Table 1** Message production parameters
      ...
      +-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
      | Message Key                       | If there are spaces, the key will be parsed as multiple keys, and cannot be filtered by **Message Key** in specific message queries. |
      |                                   |                                                                                                                                      |
      |                                   | The value can contain a maximum of 128 characters.                                                                                   |
      +-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
      | Message Tag                       | Categorizes messages in a topic. Messages are produced with tags.                                                                    |
      |                                   |                                                                                                                                      |
      |                                   | The value can contain a maximum of 128 characters.                                                                                   |
      +-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
