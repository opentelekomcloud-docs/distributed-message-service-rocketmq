...
otcdocs_doc_link = '/distributed-message-service-rocketmq/umn/'
...
html_title = "Distributed Message Service (for RocketMQ) - User Guide"
...
latex_documents = [
    ('index',
     'dms_rocketmq-umn.tex',
    u'Distributed Message Service (for RocketMQ) - User Guide',
