...
.. table:: **Table 2** Request body parameters
   ...
   |                      |                 |                                                                       | N/A                                                                                                                        |
   +----------------------+-----------------+-----------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------+
   | topic_perms          | No              | Array of :ref:`topic_perms <updateuser__request_topic_perms>` objects | **Definition**                                                                                                             |
   |                      |                 |                                                                       |                                                                                                                            |
   ...
   |                      |                 |                                                                       | N/A                                                                                                                        |
   +----------------------+-----------------+-----------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------+
   | group_perms          | No              | Array of :ref:`group_perms <updateuser__request_group_perms>` objects | **Definition**                                                                                                             |
   |                      |                 |                                                                       |                                                                                                                            |
...
.. _updateuser__request_topic_perms:
...
.. _updateuser__request_group_perms:
...
.. table:: **Table 5** Response body parameters
   ...
   |                       |                                                                        | N/A                                                |
   +-----------------------+------------------------------------------------------------------------+----------------------------------------------------+
   | topic_perms           | Array of :ref:`topic_perms <updateuser__response_topic_perms>` objects | **Definition**                                     |
   |                       |                                                                        |                                                    |
   |                       |                                                                        | Special topic permissions.                         |
   |                       |                                                                        |                                                    |
   |                       |                                                                        | **Constraints**                                    |
   ...
   |                       |                                                                        | N/A                                                |
   +-----------------------+------------------------------------------------------------------------+----------------------------------------------------+
   | group_perms           | Array of :ref:`group_perms <updateuser__response_group_perms>` objects | **Definition**                                     |
   |                       |                                                                        |                                                    |
   |                       |                                                                        | Special consumer group permissions.                |
   |                       |                                                                        |                                                    |
   |                       |                                                                        | **Constraints**                                    |
...
.. _updateuser__response_topic_perms:
...
.. _updateuser__response_group_perms:
