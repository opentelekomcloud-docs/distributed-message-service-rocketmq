:original_name: ListTopicAccessPolicy.html

.. _ListTopicAccessPolicy:
...
.. table:: **Table 3** Response body parameters
   ...
   +=======================+=============================================================================+======================================+
   | policies              | Array of :ref:`policies <listtopicaccesspolicy__response_policies>` objects | **Definition**                       |
   |                       |                                                                             |                                      |
   |                       |                                                                             | User list.                           |
   |                       |                                                                             |                                      |
   |                       |                                                                             | **Constraints**                      |
...
.. _listtopicaccesspolicy__response_policies:
