...
project = 'Distributed Message Service (for RocketMQ)'
otcdocs_repo_name = 'opentelekomcloud-docs/distributed-message-service-rocketmq'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/distributed-message-service-rocketmq/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'application'
otcdocs_service_title = 'Distributed Message Service (for RocketMQ)'
otcdocs_service_type = 'dms_rocketmq'
...
html_title = "Distributed Message Service (for RocketMQ) - API Reference"
...
latex_documents = [
    ('index',
     'dms_rocketmq-api-ref.tex',
    u'Distributed Message Service (for RocketMQ) - API Reference',
